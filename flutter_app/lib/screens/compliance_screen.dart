    ...
    return ListView(
      ...
      children: [
        ...
        const _Body(
          ...
          '  •  Dump it from a Sega Saturn you own.\n'
          '  •  Buy a licensed set -- Yaba Sanshiro 2 (Cloanto) bundles '
          'Sega-licensed BIOS images with its App Store release.\n'
          '  •  Copy one from an existing Mednafen / RetroArch / Yabause '
          'installation you already run.\n\n'
