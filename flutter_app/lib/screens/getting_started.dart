...
class GettingStartedSteps {
  ...
  static GuideStep whatYouNeed() => GuideStep(
        title: 'What a Saturn needs',
        icon: Icons.help_outline,
        body: <Widget>[
          _p(
            'This app is a Sega Saturn — a console from 1994 — running inside '
            'your device. Like the real machine, it needs two things: the '
            'console\'s own startup software, and games.',
          ),
          _point(
            Icons.memory,
            'A Saturn BIOS',
            'The console\'s built-in software, a 512 KiB file usually named '
                'saturn_bios.bin. It is Sega\'s copyright and not included — '
                'supply one dumped from a console you own, exactly as with '
                'every other Saturn emulator. Nothing boots without it.',
          ),
          _point(
            Icons.album_outlined,
            'Games',
            'Disc images: .chd is the usual choice (one compressed file per '
                'game); .cue with its .bin tracks, .iso, .mds and .ccd all '
                'work too.',
          ),
          if (Platform.isIOS)
            _point(
  ...
  static GuideStep whereFilesGo() {
      ...
      return GuideStep(
        ...
        body: <Widget>[
          ...
          _point(
            ...
            'Then open the folder named Retro-Saturn. The app creates it on '
                'first run.',
          ),
          _point(
      ...
      return GuideStep(
        ...
        body: <Widget>[
          ...
          _point(
            ...
            'Disc images are large, so the app reads them in place rather '
                'than copying them — and Android requires the All files '
                'access permission for that. The wizard opens the system '
    ...
    return GuideStep(
      ...
      body: <Widget>[
        _p(
          'Choose the folder your BIOS and disc images live in — anywhere '
